...
class Calculator extends JFrame implements ActionListener {
	...
	JButton a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, aa, as, ad, am, ae, aeq, aeq1, api, aexp, asqur, asqu, acu, asin, acos, atan;
	...
	asqur = new JButton("asqur");
	asqu = new JButton("x^2");
	acu = new JButton("x^3");
	...
	asqur.addActionListener(c);
	asqu.addActionListener(c);
	acu.addActionListener(c);
	asin.addActionListener(c);
	acos.addActionListener(c);
	atan.addActionListener(c);
